...
const Electronic = () => {
  return (
    <div className='bg-white'>
      <div className='w-full  xl:w-[75%] max-2xl:w-[80%] m-auto'>
        <div className='w-full flex justify-center items-center pb-10 '>
          <div className='flex justify-between m-1'>
            <div className='w-[65%] max-lg:w-full overflow-hidden pt-8'>
                ...
                <div className='grid grid-cols-2 max-md:grid-cols-1 gap-12  pt-4 font-koulen text-xl text-black '>
                  <div className='shadow-sm h-[570px] overflow-hidden rounded-xl hover:scale-[1.02] duration-200 cursor-pointer'>
                    <div className='w-full h-[380px] relative'>
                      ...
                      <NavLink to="/electronic"><button className='py-1 px-4 bg-secondary text-lg max-lg:text-lg border-4 border-white font-koulen text-white absolute left-4 bottom-0 '>ឧបករណ៍អេឡិចត្រូនិច​</button></NavLink>
                    </div>
            ...
            <div className='w-[30%] max-lg:hidden '>
              <div className='mt-8'>
                <div className='flex  font-koulen text-black items-top text-2xl'>
                  <div className='w-1 h-8 bg-orange-500 mr-2'></div>
